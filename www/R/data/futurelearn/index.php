...
<head>
  <title>Data for FutureLearn</title>
...
<body>
  <div id="container">
    <h1>iNZight: Data for FutureLearn</h1>



    <div style="margin:20px auto;">
      If you are using iNZight Online, then under Data, select URL. Right click one of the
      links to the desired data set below and select "Copy link" (or something similar
      depending on your browser).  Now you can paste this into the field on the iNZight
      Online page.
    </div>
...
?>       
  ...
  <?php $email = 'inzight_support@stat.auckland.ac.nz'; ?>
  <p class="footer">
    For technical support, please contact <a href="<?php echo $email; ?>"><?php echo $email; ?></a>.
  </p>
  </div>
</body>
</html>
